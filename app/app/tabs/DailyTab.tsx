    ...
    if (!hasPlan) {
      return {
        ...
        detail: pickByLang(lang, {
          en: "Without a plan, SignalCore cannot protect your risk. This takes about 2 minutes.",
          pt: "Sem plano, o SignalCore nao consegue proteger o risco. Leva cerca de 2 minutos.",
          es: "Sin plan, SignalCore no puede proteger el riesgo. Tarda unos 2 minutos.",
          fr: "Sans plan, SignalCore ne peut pas proteger votre risque. Environ 2 minutes.",
          de: "Ohne Plan kann SignalCore dein Risiko nicht schuetzen. Dauert etwa 2 Minuten.",
          it: "Senza piano, SignalCore non puo proteggere il rischio. Circa 2 minuti.",
        }),
