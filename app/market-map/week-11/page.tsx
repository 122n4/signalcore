      ...
      <header className="sticky top-0 z-50 border-b border-border-soft bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-semibold">Syntrake</span>
          </Link>

          <nav className="hidden items-center gap-6 text-sm text-ink-700 md:flex">
            <Link className="hover:text-ink-900" href="/how-it-works">
              How it works
            </Link>
            <Link className="hover:text-ink-900" href="/market-map">
              Market Map
            </Link>
            <Link className="hover:text-ink-900" href="/market-map/archive">
              Archive
            </Link>
          </nav>
