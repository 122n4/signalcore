  ...
  return (
    <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm space-y-3">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        ...
        {field("Max FX exposure (%)", plan.guardrails.maxFxExposurePct, (v) => setG("maxFxExposurePct", v), "60")}
        {field("Max crypto (%)", plan.guardrails.maxCryptoPct, (v) => setG("maxCryptoPct", v), "10")}
