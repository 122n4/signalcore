...
const YEARLY_SETUP_OUTPUT = path.resolve(
  "artifacts/trading-backtests/trading-setup-segmentation-local-2020-2025-yearly-live_risk_shaped_indices.json",
);
const YEARLY_MARKET_SESSION_OUTPUT = path.resolve(
  "artifacts/trading-backtests/trading-market-session-study-local-2020-2025-live_risk_shaped_indices.json",
);
