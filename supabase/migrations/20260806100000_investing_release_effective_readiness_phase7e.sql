...
create trigger investing_effective_revocations_immutable before update or delete on public.investing_effective_readiness_revocations
 for each row execute function public.investing_phase7e_immutable_v1();
alter table public.investing_release_candidates enable row level security;
alter table public.investing_release_candidates force row level security;
alter table public.investing_effective_beta_readiness enable row level security;
alter table public.investing_effective_beta_readiness force row level security;
alter table public.investing_effective_readiness_revocations enable row level security;
alter table public.investing_effective_readiness_revocations force row level security;
