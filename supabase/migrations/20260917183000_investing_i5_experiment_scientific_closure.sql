...
alter table investing.research_experiments
  add column experiment_hash_algorithm text,
  add column experiment_hash_domain text,
  add column experiment_hash_version text,
  add column experiment_hash_hex text,
