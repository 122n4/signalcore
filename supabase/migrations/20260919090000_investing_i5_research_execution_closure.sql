...
create policy research_run_input_create_tenants_select on investing.tenants for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_RUN_INPUT_SCIENTIFIC_CREATE_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_MUTATE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and tenant_id::text = current_setting('syntrake.investing.tenant_id', true) and state = 'ACTIVE');
create policy research_run_input_create_memberships_select on investing.tenant_memberships for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_RUN_INPUT_SCIENTIFIC_CREATE_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_MUTATE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and tenant_membership_id::text = current_setting('syntrake.investing.tenant_membership_id', true) and tenant_id::text = current_setting('syntrake.investing.tenant_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and role = 'OWNER' and state = 'ACTIVE');
create policy research_run_input_create_investigation_selector_select on investing.research_investigations for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_RUN_INPUT_SCIENTIFIC_CREATE_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_MUTATE' and coalesce(current_setting('syntrake.investing.operation_scope', true), '') = '' and coalesce(current_setting('syntrake.investing.tenant_id', true), '') = '' and coalesce(current_setting('syntrake.investing.tenant_membership_id', true), '') = '' and coalesce(current_setting('syntrake.investing.account_id', true), '') = '' and coalesce(current_setting('syntrake.investing.account_access_id', true), '') = '' and research_investigation_id::text = current_setting('syntrake.investing.research_investigation_id', true) and actor_kind = 'USER_PRINCIPAL' and actor_id = current_setting('syntrake.investing.actor_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and capability = 'RESEARCH_MUTATE');
create policy research_run_input_create_investigation_parent_select on investing.research_investigations for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_RUN_INPUT_SCIENTIFIC_CREATE_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_MUTATE' and research_investigation_id::text = current_setting('syntrake.investing.research_investigation_id', true) and actor_kind = 'USER_PRINCIPAL' and actor_id = current_setting('syntrake.investing.actor_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and tenant_id::text = current_setting('syntrake.investing.tenant_id', true) and tenant_membership_id::text = current_setting('syntrake.investing.tenant_membership_id', true) and operation_scope = 'TENANT_SCOPE' and source_context = 'PURE_RESEARCH' and account_id is null and account_access_id is null and coalesce(current_setting('syntrake.investing.account_id', true), '') = '' and coalesce(current_setting('syntrake.investing.account_access_id', true), '') = '' and capability = 'RESEARCH_MUTATE');
create policy research_run_input_create_experiments_select on investing.research_experiments for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_RUN_INPUT_SCIENTIFIC_CREATE_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_MUTATE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and current_setting('syntrake.investing.source_context', true) = 'PURE_RESEARCH' and tenant_id::text = current_setting('syntrake.investing.tenant_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and tenant_membership_id::text = current_setting('syntrake.investing.tenant_membership_id', true) and account_id is null and operation_scope = 'TENANT_SCOPE' and source_context = 'PURE_RESEARCH');
create policy research_run_input_create_spec_revisions_select on investing.research_spec_revisions for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_RUN_INPUT_SCIENTIFIC_CREATE_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_MUTATE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and current_setting('syntrake.investing.source_context', true) = 'PURE_RESEARCH' and tenant_id::text = current_setting('syntrake.investing.tenant_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and tenant_membership_id::text = current_setting('syntrake.investing.tenant_membership_id', true) and account_id is null and operation_scope = 'TENANT_SCOPE' and source_context = 'PURE_RESEARCH');

create policy research_execution_investigation_selector_select on investing.research_investigations for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_EXECUTION_RUN_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_EXECUTE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and current_setting('syntrake.investing.source_context', true) = 'PURE_RESEARCH' and research_investigation_id::text = current_setting('syntrake.investing.research_investigation_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and operation_scope = 'TENANT_SCOPE' and source_context = 'PURE_RESEARCH' and account_id is null and account_access_id is null);
create policy research_execution_run_input_selector_select on investing.run_inputs_scientific_identities for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_EXECUTION_RUN_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_EXECUTE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and current_setting('syntrake.investing.source_context', true) = 'PURE_RESEARCH' and research_investigation_id::text = current_setting('syntrake.investing.research_investigation_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and operation_scope = 'TENANT_SCOPE' and source_context = 'PURE_RESEARCH' and account_id is null);
create policy research_execution_membership_selector_select on investing.tenant_memberships for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_EXECUTION_RUN_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_EXECUTE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and current_setting('syntrake.investing.source_context', true) = 'PURE_RESEARCH' and principal_id::text = current_setting('syntrake.investing.principal_id', true) and role = 'OWNER' and state = 'ACTIVE');
create policy research_execution_tenant_selector_select on investing.tenants for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_EXECUTION_RUN_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_EXECUTE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and current_setting('syntrake.investing.source_context', true) = 'PURE_RESEARCH' and state = 'ACTIVE' and exists (select 1 from investing.tenant_memberships tm where tm.tenant_id = tenants.tenant_id and tm.principal_id::text = current_setting('syntrake.investing.principal_id', true) and tm.role = 'OWNER' and tm.state = 'ACTIVE'));
...
create policy research_execution_research_ir_select on investing.research_ir_scientific_identities for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_EXECUTION_RUN_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_EXECUTE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and current_setting('syntrake.investing.source_context', true) = 'PURE_RESEARCH' and tenant_id::text = current_setting('syntrake.investing.tenant_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and tenant_membership_id::text = current_setting('syntrake.investing.tenant_membership_id', true) and account_id is null and operation_scope = 'TENANT_SCOPE' and source_context = 'PURE_RESEARCH');
create policy research_run_input_create_research_ir_select on investing.research_ir_scientific_identities for select to investing_app
  using (current_setting('syntrake.investing.operation', true) = 'RESEARCH_RUN_INPUT_SCIENTIFIC_CREATE_V1' and current_setting('syntrake.investing.capability', true) = 'RESEARCH_MUTATE' and current_setting('syntrake.investing.operation_scope', true) = 'TENANT_SCOPE' and current_setting('syntrake.investing.source_context', true) = 'PURE_RESEARCH' and tenant_id::text = current_setting('syntrake.investing.tenant_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and tenant_membership_id::text = current_setting('syntrake.investing.tenant_membership_id', true) and account_id is null and operation_scope = 'TENANT_SCOPE' and source_context = 'PURE_RESEARCH');
...
create policy research_execution_events_select on investing.research_execution_run_events for select to investing_app
  using (operation = current_setting('syntrake.investing.operation', true) and capability = current_setting('syntrake.investing.capability', true) and tenant_id::text = current_setting('syntrake.investing.tenant_id', true) and principal_id::text = current_setting('syntrake.investing.principal_id', true) and tenant_membership_id::text = current_setting('syntrake.investing.tenant_membership_id', true) and account_id is null and operation_scope = 'TENANT_SCOPE' and source_context = 'PURE_RESEARCH');
create policy research_execution_events_owner_transition_select on investing.research_execution_run_events for select to investing_owner
  using (true);
