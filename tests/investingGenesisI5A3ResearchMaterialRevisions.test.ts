...
describe("Investing I5-A3 Research material revisions", () => {
  ...
  it("keeps idempotent writer semantics lock-or-create and CAS based", () => {
    ...
    expect(writer).toContain("and active_hypothesis_revision_id is not distinct from $10");
    expect(writer).toContain("and active_spec_revision_id is not distinct from $11");
    expect(writer).toContain("and active_experiment_id is not distinct from $12");
